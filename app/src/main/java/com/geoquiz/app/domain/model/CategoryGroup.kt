...
enum class CategoryGroup(
    ...
    LETTER_PATTERNS("letter_patterns", "Letter Patterns", "Double letters, repeated letters, and more", 7),
    WORD_PATTERNS("word_patterns", "Word Patterns", "Word counts, suffixes, and keywords", 8),
